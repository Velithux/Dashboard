...
**Contract:** `TokenVelith.sol`
**Network (testnet):** Ethereum Sepolia
**Address:** `0x18334D731FC40df8544729504fD0dC35040490E4`
**Verified:** https://sepolia.etherscan.io/address/0x18334D731FC40df8544729504fD0dC35040490E4#code
**Standard:** ERC-20 (OpenZeppelin v5.0)
**Solidity:** ^0.8.20

### B. AI Agent Architecture

The Velith AI system consists of several interconnected modules. The architecture is proprietary. What we can disclose:

- An hourly orchestration loop manages VELA's decision cycle
- A language model reasoning engine processes market data and produces structured decisions
- A data aggregation layer collects on-chain and market data
- A transaction execution module signs and submits on-chain actions
- A performance evaluation module scores past decisions
- A reporting module generates weekly transparency PDFs
- A prediction engine runs on a faster cycle, feeding signals to VELA

### C. Oracle Addresses (Sepolia Testnet)

- **ETH/USD:** `0x694AA1769357215DE4FAC081bf1f309aDC325306`
- **BTC/USD:** `0x1b44F3514812d835EB1BDB0acB33d3fA3351Ee43`

All oracle calls are validated for freshness, positive price, and round completeness before use.

### D. Key Events

```solidity
event VelithPurchased(
...
event AiExecutorUpdated(address old, address newExecutor);
```

### E. Governance Safe

**Gnosis Safe (2/2):** `0x00388Ea274fce6B2a6773852E1C1693739d675b0`
- Threshold: 2 of 2 signers required
- All administrative transactions require dual approval
